  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button onClick={openNew} className="btn-primary flex items-center gap-2 touch-manipulation">
                  ...
                  <tr key={p.id} className="hover:bg-gray-50">
                    ...
                    <td className="table-cell">
                      <div className="flex items-center gap-2">
                        <button onClick={() => openEdit(p)} className="p-1 hover:bg-gray-100 rounded touch-manipulation"><Edit2 className="w-4 h-4 text-gray-500" /></button>
                        <button onClick={() => handleDelete(p)} className="p-1 hover:bg-red-50 rounded touch-manipulation"><Trash2 className="w-4 h-4 text-red-500" /></button>
                      </div>
                    </td>
                  </tr>
                );
